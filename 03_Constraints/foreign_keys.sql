...
ADD CONSTRAINT fk_ts_task FOREIGN KEY (TaskID) REFERENCES TASK(TaskID) ON DELETE CASCADE;

ALTER TABLE TASK_STAFF
ADD CONSTRAINT fk_ts_staff FOREIGN KEY (StaffID) REFERENCES STAFF(StaffID) ON DELETE CASCADE;