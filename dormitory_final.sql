-- ==========================================
-- 0. CLEANUP (DROP TABLES IF EXISTS)
-- ==========================================
BEGIN
   -- Önce Bağlantı/Köprü Tabloları (Child Tables) silinir
   EXECUTE IMMEDIATE 'DROP TABLE STUDENT_VISITOR CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE TASK_SUPPLY CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE TASK_STAFF CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE MENU_SUPPLY CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE STUDENT_TRANSACTION CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE STAFF_TRANSACTION CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE ROOM_BILLING CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE MENU_BILLING CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE ROOM_ASSIGNMENT CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE STUDENT_PHONE CASCADE CONSTRAINTS';

   -- Sonra İşlem ve Alt Tablolar silinir
   EXECUTE IMMEDIATE 'DROP TABLE DORM_TRANSACTION CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE TASK CASCADE CONSTRAINTS';
   EXECUTE IMMEDIATE 'DROP TABLE VISITOR CASCADE CONSTRAINTS';

   -- En Son Ana Tablolar (Parent Tables) silinir
...
EXCEPTION
   WHEN OTHERS THEN NULL; -- Eğer tablo zaten yoksa hata vermeden devam et
END;
/
...
ALTER TABLE STUDENT_VISITOR ADD CONSTRAINT pk_student_visitor PRIMARY KEY (VisitorID);
...
ALTER TABLE STUDENT_VISITOR ADD CONSTRAINT fk_sv_visitor FOREIGN KEY (VisitorID) REFERENCES VISITOR(VisitorID) ON DELETE CASCADE;
ALTER TABLE STUDENT_VISITOR ADD CONSTRAINT fk_sv_student FOREIGN KEY (StudentID) REFERENCES STUDENT(StudentID) ON DELETE CASCADE;
...
ALTER TABLE VISITOR ADD CONSTRAINT check_visitor_dates CHECK (ExitDate >= EntryDate);
-- ==========================================
-- 5. INSERT DATA
-- ==========================================
...
-- 4. STUDENT TABLE
INSERT INTO STUDENT VALUES (1001, 11111111110, 'Emma', 'Rose', 'Johnson', 'New York', TO_DATE('2002-05-15', 'YYYY-MM-DD'), TO_DATE('2024-09-01', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1002, 11111111112, 'Olivia', 'Grace', 'Williams', 'London', TO_DATE('2003-08-20', 'YYYY-MM-DD'), TO_DATE('2024-09-01', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1003, 11111111114, 'Ava', 'Marie', 'Brown', 'Paris', TO_DATE('2001-02-10', 'YYYY-MM-DD'), TO_DATE('2023-09-01', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1004, 11111111116, 'Isabella', 'Jane', 'Jones', 'Berlin', TO_DATE('2002-11-05', 'YYYY-MM-DD'), TO_DATE('2024-09-02', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1005, 11111111118, 'Sophia', 'Lynn', 'Garcia', 'Madrid', TO_DATE('2003-04-12', 'YYYY-MM-DD'), TO_DATE('2024-09-03', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1006, 11111111120, 'Mia', 'Elizabeth', 'Miller', 'Rome', TO_DATE('2002-09-25', 'YYYY-MM-DD'), TO_DATE('2024-09-04', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1007, 11111111122, 'Charlotte', 'Ann', 'Davis', 'Toronto', TO_DATE('2001-12-30', 'YYYY-MM-DD'), TO_DATE('2023-09-05', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1008, 11111111124, 'Amelia', 'Kate', 'Rodriguez', 'Sydney', TO_DATE('2003-06-18', 'YYYY-MM-DD'), TO_DATE('2024-09-05', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1009, 11111111126, 'Evelyn', 'Claire', 'Martinez', 'Tokyo', TO_DATE('2002-01-22', 'YYYY-MM-DD'), TO_DATE('2024-09-06', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1010, 11111111128, 'Abigail', 'Faith', 'Hernandez', 'Dublin', TO_DATE('2003-10-08', 'YYYY-MM-DD'), TO_DATE('2024-09-07', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1011, 11111111130, 'Harper', 'Sue', 'Lopez', 'Amsterdam', TO_DATE('2001-07-14', 'YYYY-MM-DD'), TO_DATE('2023-09-08', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1012, 11111111132, 'Emily', 'Rose', 'Gonzalez', 'Vienna', TO_DATE('2002-03-03', 'YYYY-MM-DD'), TO_DATE('2024-09-09', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1013, 11111111134, 'Elizabeth', 'Hope', 'Wilson', 'Prague', TO_DATE('2003-11-28', 'YYYY-MM-DD'), TO_DATE('2024-09-10', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1014, 11111111136, 'Sofia', 'Grace', 'Anderson', 'Lisbon', TO_DATE('2002-05-09', 'YYYY-MM-DD'), TO_DATE('2024-09-11', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1015, 11111111138, 'Avery', 'May', 'Thomas', 'Brussels', TO_DATE('2001-08-16', 'YYYY-MM-DD'), TO_DATE('2023-09-12', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1016, 11111111140, 'Ella', 'Joy', 'Taylor', 'Oslo', TO_DATE('2003-02-24', 'YYYY-MM-DD'), TO_DATE('2024-09-13', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1017, 11111111142, 'Madison', 'Lee', 'Moore', 'Stockholm', TO_DATE('2002-12-01', 'YYYY-MM-DD'), TO_DATE('2024-09-14', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1018, 11111111144, 'Scarlett', 'Rae', 'Jackson', 'Helsinki', TO_DATE('2003-09-19', 'YYYY-MM-DD'), TO_DATE('2024-09-15', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1019, 11111111146, 'Victoria', 'Skye', 'Martin', 'Copenhagen', TO_DATE('2001-04-27', 'YYYY-MM-DD'), TO_DATE('2023-09-16', 'YYYY-MM-DD'));
INSERT INTO STUDENT VALUES (1020, 11111111148, 'Luna', 'Belle', 'Lee', 'Athens', TO_DATE('2002-10-11', 'YYYY-MM-DD'), TO_DATE('2024-09-17', 'YYYY-MM-DD'));
...
-- ==========================================
-- MISSING INSERTS (PERSON 4: VISITOR MANAGEMENT)
-- ==========================================

-- 17. VISITOR TABLE
INSERT INTO VISITOR VALUES (1, 'Michael', 'John', 'Johnson', TO_DATE('2025-10-01 10:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-01 14:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (2, 'Susan', NULL, 'Williams', TO_DATE('2025-10-02 09:30', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-02 11:30', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (3, 'James', NULL, 'Brown', TO_DATE('2025-10-02 15:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-02 18:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (4, 'Linda', 'May', 'Jones', TO_DATE('2025-10-03 12:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-03 16:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (5, 'David', NULL, 'Garcia', TO_DATE('2025-10-04 10:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-04 12:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (6, 'Patricia', NULL, 'Miller', TO_DATE('2025-10-05 14:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-05 17:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (7, 'John', 'Robert', 'Davis', TO_DATE('2025-10-06 09:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-06 10:30', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (8, 'Jennifer', NULL, 'Rodriguez', TO_DATE('2025-10-06 16:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-06 19:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (9, 'William', NULL, 'Martinez', TO_DATE('2025-10-07 11:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-07 13:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (10, 'Elizabeth', NULL, 'Hernandez', TO_DATE('2025-10-08 13:30', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-08 15:30', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (11, 'Richard', NULL, 'Lopez', TO_DATE('2025-10-09 10:00', 'YYYY-MM-DD HH24:MI'), NULL); 
INSERT INTO VISITOR VALUES (12, 'Barbara', NULL, 'Gonzalez', TO_DATE('2025-10-09 14:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-09 16:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (13, 'Joseph', 'Lee', 'Wilson', TO_DATE('2025-10-10 09:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-10 11:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (14, 'Margaret', NULL, 'Anderson', TO_DATE('2025-10-10 15:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-10 17:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (15, 'Thomas', NULL, 'Thomas', TO_DATE('2025-10-11 12:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-11 14:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (16, 'Nancy', 'Jean', 'Taylor', TO_DATE('2025-10-12 10:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-12 18:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (17, 'Charles', NULL, 'Moore', TO_DATE('2025-10-13 09:30', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-13 10:30', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (18, 'Lisa', NULL, 'Jackson', TO_DATE('2025-10-14 14:00', 'YYYY-MM-DD HH24:MI'), NULL); 
INSERT INTO VISITOR VALUES (19, 'Christopher', 'Ray', 'Martin', TO_DATE('2025-10-15 11:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-15 13:00', 'YYYY-MM-DD HH24:MI'));
INSERT INTO VISITOR VALUES (20, 'Karen', NULL, 'Lee', TO_DATE('2025-10-16 16:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-16 17:30', 'YYYY-MM-DD HH24:MI'));

-- 18. STUDENT_VISITOR TABLE
INSERT INTO STUDENT_VISITOR VALUES (1, 1001); 
INSERT INTO STUDENT_VISITOR VALUES (2, 1002); 
INSERT INTO STUDENT_VISITOR VALUES (3, 1003); 
INSERT INTO STUDENT_VISITOR VALUES (4, 1004); 
INSERT INTO STUDENT_VISITOR VALUES (5, 1005); 
INSERT INTO STUDENT_VISITOR VALUES (6, 1006); 
INSERT INTO STUDENT_VISITOR VALUES (7, 1007); 
INSERT INTO STUDENT_VISITOR VALUES (8, 1008); 
INSERT INTO STUDENT_VISITOR VALUES (9, 1009); 
INSERT INTO STUDENT_VISITOR VALUES (10, 1010);
INSERT INTO STUDENT_VISITOR VALUES (11, 1011);
INSERT INTO STUDENT_VISITOR VALUES (12, 1012);
INSERT INTO STUDENT_VISITOR VALUES (13, 1013);
INSERT INTO STUDENT_VISITOR VALUES (14, 1014);
INSERT INTO STUDENT_VISITOR VALUES (15, 1015);
INSERT INTO STUDENT_VISITOR VALUES (16, 1016);
INSERT INTO STUDENT_VISITOR VALUES (17, 1017);
INSERT INTO STUDENT_VISITOR VALUES (18, 1018);
INSERT INTO STUDENT_VISITOR VALUES (19, 1019);
INSERT INTO STUDENT_VISITOR VALUES (20, 1020);
